...
@property(nonatomic, strong) NSNumber *mapWidthSize;
@property(nonatomic, strong) NSNumber *mapHeightSize;

@property(nonatomic, strong) UILabel *clusterLbl;
@property(nonatomic, strong) UILabel *mapWidthLbl;
@property(nonatomic, strong) UILabel *mapHeightLbl;
